...
```javascript
// Basic Information
valentineName: "NISARGHA JI"                    // Your Valentine's name
...
questions: {
    first: {
        text: "Do you like me ji ?ahm ahm ",                   // First question
        yesBtn: "Yes",                             // Yes button text
        noBtn: "No but yes",                               // No button text
        secretAnswer: "I don't like you, I love you! ❤️"  // Hidden message
    },
    second: {
        text: "How much do you love me?",          // Second question
        startText: "This much! (pakka ji?)",                   // Text before percentage
        nextBtn: "Next ❤️"                         // Next button text
    },
    third: {
        text: "Will you be my Valentine...?",      // Final question
        yesBtn: "Yes!",                            // Yes button text
        noBtn: "( u dont have other option ) "                                // No button text
    }
}
